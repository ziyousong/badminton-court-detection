...
private:
  ...
  static std::vector<LinePair> getParallelLinePairs(const std::vector<Line>& lines, const cv::Mat& rgbImage);

  void findBestModelFit2(const std::vector<Line>& lines, const cv::Mat& binaryImage, const cv::Mat& rgbImage);
